...
image_path = "datasets/input_image.png"
...
def distorded_cordinates(camera_position, camera_angles, rectangle_coordinates):
    ...
    for x, y in rectangle_coordinates:
        #Translate image coordinates to camera coordinate system
        ...
        #Project the rotated coordinates onto the image plane
